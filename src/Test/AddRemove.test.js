...
const {
  newTodoList, remove, edit, clearAll,
...
//   });
//   test('Testing if todos are cleared in array', () => {
//     expect(clearAll()).toEqual([{ completedTask: false, description: 'completed', id: 3 }, { completedTask: false, description: 'start next task', id: 4 }, { completedTask: false, id: 5 }]);
//   });
// });
// describe('Clearing all items in todos', () => {
//   test('check if clearAll is a function', () => {
